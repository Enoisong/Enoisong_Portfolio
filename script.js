...
const cardsInfo = [
  ...
  },
  {
    ...
    description: 'Metrics is a single page web application that allows users to explore population by country and view details of an individual country from an API.',
    tech_stack: {
      tech1: 'HTML',
      tech2: 'CSS',
      tech3: 'JavaScript',
    },
    liveLink: 'https://metric-app-7uio.onrender.com/',
    sourceLink: 'https://github.com/Enoisong/metric_app.git',
  },
  {
    id: 3,
    class: 'calculator',
  ...
  },
  {
    ...
    image: 'move.png',
    title: 'MovieBest',
    description: 'MovieBest is an API-based app that allows client to have the best movie browsing experience',
    tech_stack: {
      tech1: 'React',
      tech2: 'Redux',
      tech3: 'API',
    },
    liveLink: 'https://moviebest.onrender.com/',
    sourceLink: 'https://github.com/Enoisong/ruby-capstone-project.git',
  },
  {
    id: 6,
    class: 'budget',
